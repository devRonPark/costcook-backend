...
public interface ReviewRepository extends JpaRepository<Review, Long>{
	...
	// 리뷰 목록 생성일 순으로 정렬
    @Query("SELECT r FROM Review r WHERE r.recipe.id = :recipeId ORDER BY r.updatedAt DESC")
    Page<Review> findByRecipeIdOrderByUpdatedAtDesc(@Param("recipeId") Long recipeId, Pageable pageable);
